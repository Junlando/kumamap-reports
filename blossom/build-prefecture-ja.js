 ...
 * 生成英文縣市頁面：prefecture/ja/ajisai/hokkaido.html 等
...
const FLOWERS = {
  ajisai: { label: '紫陽花',      labelFull: 'Japan 紫陽花',      year: 2026, emoji: '💠', color: '#7c5cbf', light: '#f0eafb' },
  koyo:   { label: '紅葉', labelFull: 'Japan 紅葉', year: 2026, emoji: '🍁', color: '#d4570a', light: '#fff0e6' },
  sakura: { label: '桜', labelFull: 'Japan 桜', year: 2027, emoji: '🌸', color: '#d46b8a', light: '#fff0f5' },
};
...
<header>
  <div class="header-inner">
    <a class="logo" href="../../../ja/index.html">
      <img src="/favicon.ico" style="width:32px;height:32px;border-radius:8px;display:block" alt="Junlando" />
      Junlando
    </a>
    <a class="back-btn" href="../../../ja/index.html?flower=${flower}">← 開花予報</a>
  </div>
</header>

<div class="breadcrumb-bar">
  <div class="breadcrumb-inner">
    <a href="../../../ja/index.html?flower=${flower}" style="color:var(--text-sub);text-decoration:none">開花予報</a>
...
function spotUrl(flower, name) {
  ...
  return id ? \`../../../spot/ja/\${flower}/\${id}.html\` : \`../../../spot.html?flower=\${flower}&spot=\${encodeURIComponent(name)}\`;
}

const FLOWERS = {
  ajisai: { label: '紫陽花',      emoji: '💠', color: '#7c5cbf', light: '#f0eafb' },
  ...
  try {
    ...
    if (!fc) {
      ...
      app.innerHTML = \`<div class="error-msg"><h2>No data found for "\${ken}"</h2>
        <p style="margin-top:8px"><a href="../../../ja/index.html" style="color:var(--active)">← Back to 開花予報</a></p></div>\`;
      return;
    }
...
for (const [flower, flowerInfo] of Object.entries(FLOWERS)) {
  ...
  console.log(`✅ en/${flower}: ${count} prefectures → prefecture/ja/${flower}/`);
}

// 寫 sitemap
const sitemapPath = path.join(BASE_DIR, 'sitemap-ja.xml');
